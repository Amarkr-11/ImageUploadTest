package com.imageuploadtest.controller;

import com.imageuploadtest.payloads.FileResponse;
...
public class ImageController {
    ...
    public ResponseEntity<FileResponse> imageupload(@RequestParam("image")MultipartFile image) {
        ...
        try {
            fileName = this.imageUploadService.uploadImage(path,image);
        } catch (IOException e) {
           e.printStackTrace();
    ...
    public void downloadImage(@PathVariable("imageName") String imageName,
        ...
        InputStream image = this.imageUploadService.getImage(path, imageName);
